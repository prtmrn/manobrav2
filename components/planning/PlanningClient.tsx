      ...
      <div className="flex items-center gap-3 px-4 py-2.5 border-b border-gray-100 bg-white flex-shrink-0">
        ...
        <div className="relative">
          {showSearch ? (
            ...
            <button onClick={() => setShowSearch(true)} className="hidden lg:flex p-1.5 rounded-lg hover:bg-gray-100 text-gray-500 transition-colors">
        ...
        {/* Sélecteur vue */}
        <div className="hidden lg:flex items-center border border-gray-200 rounded-lg overflow-hidden text-xs font-semibold">
...
function CreateEventModal({
  ...
  const [type, setType] = useState<"choix" | "dispo" | "evenement" | "indispo">(heureFin ? "evenement" : "choix");
  ...
  const [fin, setFin] = useState(heureFin ?? defaultFin());
  ...
  const [dispoFin, setDispoFin] = useState(heureFin ?? defaultFin());
