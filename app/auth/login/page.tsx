      ...
      <div className="w-full max-w-md space-y-7">
        ...
        <div className="flex justify-center">
          <button
            ...
            className="relative flex items-center gap-3 bg-white border border-gray-200 rounded-full px-2 py-2 shadow-sm hover:shadow transition-shadow"
            aria-label="Changer de mode"
          >
            {/* Label gauche */}
            <span className={`text-xs font-semibold pl-1 transition-colors ${
            ...
            {/* Interrupteur */}
            <div className="relative w-12 h-6 bg-brand-600 rounded-full transition-colors">
              <div className={`absolute top-1 w-4 h-4 bg-white rounded-full shadow transition-transform duration-200 ${
                mode === "client" ? "left-1" : "left-7"
              }`} />
            </div>

            {/* Label droite */}
            <span className={`text-xs font-semibold pr-1 transition-colors ${
